    ...
    <div id="contents">
		<div class="container project-page">
			...
			<div class="box-project-favorite">
				<h2 class="title-page">Dự án được ưa thích nhất</h2>
			...
			<div class="box-project-favorite">
				<h2 class="title-page">Dự án có chủ đầu tư uy tín nhất</h2>
				<ul class="list-project-favorite">
					<li class="item-pr">
		        		<div class="product-item">
		        			<div class="product-images">
			...
			<div class="box-project-favorite">
				<h2 class="title-page">Dự án giao thông thuận tiện nhất</h2>
				<ul class="list-project-favorite">
					<li class="item-pr">
		        		<div class="product-item">
		        			<div class="product-images">
